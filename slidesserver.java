...
String st,stl[]=new String[100]; System.out.println("Type\"Stop\"to exit");
s=ser.accept();
pout=new PrintStream(s.getOutputStream());
DataInputStream rin=new DataInputStream(s.getInputStream()); System.out.println("enter data to be send:");
while(true)
{
st=in.readLine();
l=st.length();
...
if(i%ws!=0)
{
System.out.println(rin.readLine()); System.out.println("enter next data to send");
}
}}}